...
<ProjectCard
  title="✨Nikahanku"
  link="https://nikahanku.id"
  bg="linear-gradient(to right, #D4145A 0%, #FBB03B 100%)"
>
  Undangan pernikahan online digital berbasis web. Cek disini yang mau nikah.
</ProjectCard>
<ProjectCard
  title="Shutterstock"
  link="https://www.shutterstock.com/g/Ardo+Sarofa"
  bg="linear-gradient(to right, #662D8C 0%, #ED1E79 100%)"
>
  Lihat hasil jeperetanku di Shutterstock.
</ProjectCard>
<ProjectCard
  title="Fiverr"
  link="https://www.fiverr.com/ardosarofa"
  bg="linear-gradient(to right, #009245 0%, #FCEE21 100%)"
>
  Aku punya beberapa jasa disini. Cek Gigs-nya di Fiverr.
</ProjectCard>
<ProjectCard
  title="Youtube"
  link="https://www.youtube.com/c/ArdoSaputra?sub_confirmation=1"
  bg="linear-gradient(to right, #FF512F 0%, #DD2476 100%)"
>
  Koleksi video randomku di Youtube.
</ProjectCard>
{/*
<ProjectCard
